...
export function Dashboard({
	...
	return (
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 pb-12">
            ...
            {mostSold && (
                <Card className="md:col-span-1 lg:col-span-2 overflow-hidden relative border-[rgba(245,196,0,0.25)] bg-gradient-to-br from-[rgba(245,196,0,0.05)] to-transparent shadow-[0_0_30px_-8px_rgba(245,196,0,0.2)] group">
                    <CardContent className="p-6 flex items-center gap-6 h-full">
                        <div className="relative w-28 h-28 flex-shrink-0 rounded-2xl overflow-hidden border border-[rgba(255,255,255,0.08)] shadow-[0_10px_24px_-12px_rgba(0,0,0,0.8)] transition-transform duration-500 group-hover:scale-105">
                            ...
                            <div className="absolute top-2 right-2 w-7 h-7 bg-gradient-to-br from-[#FFD84D] to-[#F5C400] rounded-full flex items-center justify-center shadow-lg">
